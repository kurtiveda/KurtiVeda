...
function page() {
  return (
    <div className="w-screen flex flex-col justify-center items-center">
      <h1 className="text-3xl  font-playfair my-10">Terms of Service</h1>
      <hr className="w-[90%]" />
      <div className="font-lato laptop:w-[50%] tablet:w-[90%] xsPhone:w-full xsPhone:px-4 text-justify space-y-6 text-sm my-12">
        <h2>OVERVIEW</h2>
        <p>
          This website is operated by Tara Enterprises. Throughout the site, the
          terms “we”, “us” and “our” refer to KURTIVEDA. KURTIVEDA offers this
        ...
        <p>
          In no case shall Tara Enterprises, our directors, officers, employees,
        ...
        <p>
          You agree to indemnify, defend and hold harmless Tara Enterprises and
